...
<div class="video-form">
    ...
    <div class="row">
        ...
        <?= $form->field($model, 'descriptipn')->textarea(['rows' => 6]) ?>

        <div class="form-group">
            <label for=""><?php echo $model->getAttributeLabel('thumnail')?></label>
            <div class="custom-file">
                <input type="file" class="custom-file-input" id="thumnail" name="thumnail">
                <label class="custom-file-label" for="thumnail">Choose file</label>
            </div>
        </div>
